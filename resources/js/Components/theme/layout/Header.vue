        ...
        <div class="shadow-sm">
            <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
                <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                    <InertiaLink to="/" class="main-logo flex items-center shrink-0">
                        <img class="w-8 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/perso/logo_wise.png" alt=""/>
                        <span
...
import IconCalendar from '@/Components/theme/icon/icon-calendar.vue';
import IconEdit from '@/Components/theme/icon/icon-edit.vue';
import IconChatNotification from '@/Components/theme/icon/icon-chat-notification.vue';
import IconSearch from '@/Components/theme/icon/icon-search.vue';
import IconXCircle from '@/Components/theme/icon/icon-x-circle.vue';
import IconSun from '@/Components/theme/icon/icon-sun.vue';
import IconMoon from '@/Components/theme/icon/icon-moon.vue';
import IconLaptop from '@/Components/theme/icon/icon-laptop.vue';
import IconMailDot from '@/Components/theme/icon/icon-mail-dot.vue';
import IconArrowLeft from '@/Components/theme/icon/icon-arrow-left.vue';
import IconInfoCircle from '@/Components/theme/icon/icon-info-circle.vue';
import IconBellBing from '@/Components/theme/icon/icon-bell-bing.vue';
...
import IconLogout from '@/Components/theme/icon/icon-logout.vue';
import IconMenuDashboard from '@/Components/theme/icon/menu/icon-menu-dashboard.vue';
import IconCaretDown from '@/Components/theme/icon/icon-caret-down.vue';
import IconMenuApps from '@/Components/theme/icon/menu/icon-menu-apps.vue';
import IconMenuComponents from '@/Components/theme/icon/menu/icon-menu-components.vue';
import IconMenuElements from '@/Components/theme/icon/menu/icon-menu-elements.vue';
import IconMenuDatatables from '@/Components/theme/icon/menu/icon-menu-datatables.vue';
import IconMenuForms from '@/Components/theme/icon/menu/icon-menu-forms.vue';
import IconMenuPages from '@/Components/theme/icon/menu/icon-menu-pages.vue';
import IconMenuMore from '@/Components/theme/icon/menu/icon-menu-more.vue';
