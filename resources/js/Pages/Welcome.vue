                    ...
                    <div class="table-responsive">
                        <table>
                            ...
                            <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                ...
                                <td><InertiaLink to="/apps/invoice/preview">#46894</InertiaLink></td>
                                <td>$56.07</td>
                            ...
                            <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                ...
                                <td><InertiaLink to="/apps/invoice/preview">#76894</InertiaLink></td>
                                <td>$126.04</td>
                            ...
                            <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                ...
                                <td><InertiaLink to="/apps/invoice/preview">#66894</InertiaLink></td>
                                <td>$56.07</td>
                                <td><span class="badge bg-success shadow-md dark:group-hover:bg-transparent">Paid</span></td>
                            </tr>
                            <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                ...
                                <td><InertiaLink to="/apps/invoice/preview">#75844</InertiaLink></td>
                                <td>$110.00</td>
                                <td><span class="badge bg-secondary shadow-md dark:group-hover:bg-transparent">Shipped</span></td>
                            </tr>
                            <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
...
import IconDollarSign from '@/Components/theme/icon/icon-dollar-sign.vue';
import IconInbox from '@/Components/theme/icon/icon-inbox.vue';
import IconTag from '@/Components/theme/icon/icon-tag.vue';
import IconCreditCard from '@/Components/theme/icon/icon-credit-card.vue';
import IconShoppingCart from '@/Components/theme/icon/icon-shopping-cart.vue';
import IconArrowLeft from '@/Components/theme/icon/icon-arrow-left.vue';
import IconCashBanknotes from '@/Components/theme/icon/icon-cash-banknotes.vue';
import IconUser from '@/Components/theme/icon/icon-user.vue';
import IconNetflix from '@/Components/theme/icon/icon-netflix.vue';
import IconBolt from '@/Components/theme/icon/icon-bolt.vue';
