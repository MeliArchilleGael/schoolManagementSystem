...
<script lang="ts" setup>
    ...
    import IconLayoutGrid from '@/Components/theme/icon/icon-layout-grid.vue';
    import IconSearch from '@/Components/theme/icon/icon-search.vue';
    import IconUser from '@/Components/theme/icon/icon-user.vue';
    import IconFacebook from '@/Components/theme/icon/icon-facebook.vue';
    import IconInstagram from '@/Components/theme/icon/icon-instagram.vue';
    import IconLinkedin from '@/Components/theme/icon/icon-linkedin.vue';
    import IconTwitter from '@/Components/theme/icon/icon-twitter.vue';
