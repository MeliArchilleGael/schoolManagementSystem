...
<script lang="ts" setup>
    ...
    import IconLogin from '@/Components/theme/icon/icon-login.vue';
    import IconSearch from '@/Components/theme/icon/icon-search.vue';
    import IconMessagesDot from '@/Components/theme/icon/icon-messages-dot.vue';
    import IconPhone from '@/Components/theme/icon/icon-phone.vue';
    import IconUserPlus from '@/Components/theme/icon/icon-user-plus.vue';
    import IconBell from '@/Components/theme/icon/icon-bell.vue';
    import IconMenu from '@/Components/theme/icon/icon-menu.vue';
    import IconPhoneCall from '@/Components/theme/icon/icon-phone-call.vue';
    import IconVideo from '@/Components/theme/icon/icon-video.vue';
    import IconCopy from '@/Components/theme/icon/icon-copy.vue';
    import IconTrashLines from '@/Components/theme/icon/icon-trash-lines.vue';
    import IconShare from '@/Components/theme/icon/icon-share.vue';
    import IconMoodSmile from '@/Components/theme/icon/icon-mood-smile.vue';
    import IconSend from '@/Components/theme/icon/icon-send.vue';
    import IconMicrophoneOff from '@/Components/theme/icon/icon-microphone-off.vue';
    import IconDownload from '@/Components/theme/icon/icon-download.vue';
    import IconCamera from '@/Components/theme/icon/icon-camera.vue';
    import IconMessage from '@/Components/theme/icon/icon-message.vue';
