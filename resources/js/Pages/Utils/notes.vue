...
<script lang="ts" setup>
    ...
    import IconNotes from '@/Components/theme/icon/icon-notes.vue';
    import IconNotesEdit from '@/Components/theme/icon/icon-notes-edit.vue';
    ...
    import IconPencil from '@/Components/theme/icon/icon-pencil.vue';
    import IconTrashLines from '@/Components/theme/icon/icon-trash-lines.vue';
    import IconEye from '@/Components/theme/icon/icon-eye.vue';
