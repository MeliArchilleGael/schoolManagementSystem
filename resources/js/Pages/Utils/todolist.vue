...
<script lang="ts" setup>
    ...
    import IconClipboardText from '@/Components/theme/icon/icon-clipboard-text.vue';
    import IconListCheck from '@/Components/theme/icon/icon-list-check.vue';
    import IconThumbUp from '@/Components/theme/icon/icon-thumb-up.vue';
    ...
    import IconSquareRotated from '@/Components/theme/icon/icon-square-rotated.vue';
    ...
    import IconPencilPaper from '@/Components/theme/icon/icon-pencil-paper.vue';
    import IconRestore from '@/Components/theme/icon/icon-restore.vue';
    import IconX from '@/Components/theme/icon/icon-x.vue';
