...
<script lang="ts" setup>
    ...
    import IconStar from '@/Components/theme/icon/icon-star.vue';
    import IconSend from '@/Components/theme/icon/icon-send.vue';
    import IconInfoHexagon from '@/Components/theme/icon/icon-info-hexagon.vue';
    import IconFile from '@/Components/theme/icon/icon-file.vue';
    import IconTrashLines from '@/Components/theme/icon/icon-trash-lines.vue';
    import IconCaretDown from '@/Components/theme/icon/icon-caret-down.vue';
    import IconArchive from '@/Components/theme/icon/icon-archive.vue';
    import IconBookmark from '@/Components/theme/icon/icon-bookmark.vue';
    import IconVideo from '@/Components/theme/icon/icon-video.vue';
    import IconChartSquare from '@/Components/theme/icon/icon-chart-square.vue';
    import IconUserPlus from '@/Components/theme/icon/icon-user-plus.vue';
    import IconPlus from '@/Components/theme/icon/icon-plus.vue';
    import IconRefresh from '@/Components/theme/icon/icon-refresh.vue';
    import IconWheel from '@/Components/theme/icon/icon-wheel.vue';
    import IconHorizontalDots from '@/Components/theme/icon/icon-horizontal-dots.vue';
    import IconOpenBook from '@/Components/theme/icon/icon-open-book.vue';
    import IconBook from '@/Components/theme/icon/icon-book.vue';
    import IconTrash from '@/Components/theme/icon/icon-trash.vue';
    import IconRestore from '@/Components/theme/icon/icon-restore.vue';
    import IconMenu from '@/Components/theme/icon/icon-menu.vue';
    import IconSearch from '@/Components/theme/icon/icon-search.vue';
    import IconSettings from '@/Components/theme/icon/icon-settings.vue';
    import IconHelpCircle from '@/Components/theme/icon/icon-help-circle.vue';
    import IconUser from '@/Components/theme/icon/icon-user.vue';
    import IconMessage2 from '@/Components/theme/icon/icon-message-2.vue';
    import IconUsers from '@/Components/theme/icon/icon-users.vue';
    import IconTag from '@/Components/theme/icon/icon-tag.vue';
    import IconPaperclip from '@/Components/theme/icon/icon-paperclip.vue';
    import IconArrowLeft from '@/Components/theme/icon/icon-arrow-left.vue';
    import IconPrinter from '@/Components/theme/icon/icon-printer.vue';
    import IconArrowBackward from '@/Components/theme/icon/icon-arrow-backward.vue';
    import IconArrowForward from '@/Components/theme/icon/icon-arrow-forward.vue';
    import IconGallery from '@/Components/theme/icon/icon-gallery.vue';
    import IconFolder from '@/Components/theme/icon/icon-folder.vue';
    import IconZipFile from '@/Components/theme/icon/icon-zip-file.vue';
    import IconDownload from '@/Components/theme/icon/icon-download.vue';
    import IconTxtFile from '@/Components/theme/icon/icon-txt-file.vue';
