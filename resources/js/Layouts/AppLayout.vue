...
<script setup lang="ts">
    ...
    import Header from '@/Components/theme/layout/Header.vue';
    import Footer from '@/Components/theme/layout/Footer.vue';
    import Sidebar from '@/Components/theme/layout/Sidebar.vue';
    import Setting from '@/Components/theme/ThemeCustomizer.vue';
